...
public class PacienteAdapter extends BaseAdapter {
    ...
    public View getView(int position, View arg1, ViewGroup arg2) {
        ...
        final RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout.activity_paciente, null);

        TextView tv = (TextView) layout.findViewById(R.id.editTextNome);
        tv.setText(list.get(position).getNome());


        Button editarBt = (Button) layout.findViewById(R.id.button2);
        editarBt.setOnClickListener(new Button.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(context, EnterPatientActivity.class);
        ...
        Button deletarBt = (Button) layout.findViewById(R.id.button3);
